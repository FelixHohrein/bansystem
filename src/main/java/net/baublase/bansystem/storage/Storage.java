...
public final class Storage {
    ...
    private Storage(boolean enabled, HikariDataSource dataSource, PlayerRepository players, SessionRepository sessions, BanRepository bans) {
    ...
    public static Storage disabled() {
        return new Storage(false, null, null, null, null);
    }
